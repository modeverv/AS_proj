...
/**
 * 存在しないファイル、またはファイルサイズが0のファイルがアップロードされた場合に投げられる例外。<br>
 * (RuntimeExceptionを継承しているので、必ずしもtry～catchで補足する必要はありません。)<br>
 */
public class UploadEmptyFileException extends RuntimeException {
	 ...
	 */
	public UploadEmptyFileException(String strArg) {
	 ...
	 */
	public UploadEmptyFileException(String strArg, Throwable childExceptionArg) {
