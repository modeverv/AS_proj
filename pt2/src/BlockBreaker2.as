...
package 
{
	...
	public class BlockBreaker2 extends Sprite 
	{
		...
		public function BlockBreaker2()
		{
			...
			var b:BitmapData = new BitmapData(800, 10, false, 0x00FF00);
			addChild(_bar = new Bitmap(b));
			_bar.y =  WIDTH - 40; //b.width/4;
			_bar.x = 400;
